                  ...
                  <div class="recipe-info">
                    <ul class="flex items-center">
                      <li class="flex items-center mr-5">
                        ...
                        <span
                          class="text-base font-normal text-gray-700 dark:text-gray-400 tracking-wider"
                      ...
                      <li class="flex items-center mr-5">
                        <span class="inline-block mr-1">
                          <svg class="w-3 h-3 fill-current text-gray-900 dark:text-gray-200" viewBox="0 0 20 20">
                            <path
