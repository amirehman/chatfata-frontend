  ...
  <div>
    <div v-if="(recipe && recipe.status === 'PUBLISHED') || isValidUser">
              ...
              <div class="flex flex-wrap">
                ...
                >
                  <div class="recipe-header-info pr-0 lg:pr-16">
                    <div
                      class="recipe-type font-semibold text-sm text-gray-600 tracking-wide"
                    >
                      by
                      <nuxt-link
                    ...
                    <div class="recipe-info">
                      <ul class="flex it  ems-center">
                        <li class="flex items-center mr-5">
                          <span class="inline-block mr-1">
                            <svg
                              class="w-4 h-4 fill-current text-gray-900 dark:text-gray-200"
                          ...
                          <span
                            class="text-base font-normal text-gray-700 dark:text-gray-400 tracking-wider ml-1"
                        ...
                        <li class="flex items-center mr-5">
                          <span class="inline-block mr-1">
                            <svg
                              class="w-3 h-3 fill-current text-gray-900 dark:text-gray-200"
                              xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 20 20"
                            >
                              <path
                                d="M10 20a10 10 0 110-20 10 10 0 010 20zm0-2a8 8 0 100-16 8 8 0 000 16zm-1-7.59V4h2v5.59l3.95 3.95-1.41 1.41L9 10.41z"
                              />
                            </svg>
                          </span>
                          <span
                        ...
                        <li class="flex items-center mr-5">
                          <span class="inline-block mr-1">
                            ...
                            >
                              <path
                                d="M9 18v-7L0 2V0h20v2l-9 9v7l5 1v1H4v-1l5-1zm2-10a2 2 0 100-4 2 2 0 000 4z"
                              />
                            </svg>
                          </span>
                          <span
                        ...
                        <li
                          ...
                          class="dark:hover:border-gray-700 text-theme-orange cursor-pointer border-b border-transparent hover:border-gray-400"
                        >
                          Edit this recipe
                        </li>
                      </ul>
                    ...
                    <!-- recipe info end -->
                    <pre>
                    <!-- {{$vToastify.getSettings()}} -->
                  </pre>

                    <div
                      class="recipe-short-description text-gray-700 dark:text-gray-400 mt-6 text-base xxl:text-lg font-normal tracking-wide"
                      v-html="recipe.body"
                    ></div>
                    <a
                      target="_blank"
      ...
      <div
        ...
        class="bar bg-white dark:bg-dark-mode-light py-3 border-t fixed bottom-0 left-0 w-full text-center text-sm"
      >
        <div>
          <span
